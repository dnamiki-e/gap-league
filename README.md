...
予想順位と実順位の差の合計が小さいほど上位（完全一致はマイナス点）。5大リーグ（プレミア / ラ・リーガ / セリエA / ブンデス / リーグアン）に対応し、シーズン × リーグ単位で予想できます。

## できること

- **順位予想** — 全チームをドラッグで並べる。実順位とのズレの合計で競う
- **得点予想** — 選手を3人まで指名。その3人の合計得点で競う（順位予想とは別ランキング）
- **ネタバレ防止** — 締切前と終盤（残り5節以下）は他人の予想・順位を自動で隠す
...
| [docs/PUBLISHING.md](docs/PUBLISHING.md) | 公開前チェックリスト |
